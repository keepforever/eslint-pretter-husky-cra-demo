                    ...
                    <div
                        data-rh={
                            !project.assigned_narrator
                                ? 'No Narrator has been assigned. A Narrator is a required field in the contract.'
                                : null
                        }
                        className="flex-col"
                    >
                        <p className="para-bold" style={{ marginBottom: '10px' }}>
                            Author/RH Contracts
                        </p>
                        <Select
                        ...
                        >
                            ...
                            {Object.keys(contractConfig)
                                .filter((el) => {
                                    return contractConfig[el].eventUserTriggeredOn === 'rights_holder';
                                })
                                .map((opt) => {
                                    return (
                                        <option key={`email_${opt}`} value={opt}>
                        ...
                        >
                            ...
                            {Object.keys(contractConfig)
                                .filter((el) => {
                                    return contractConfig[el].eventUserTriggeredOn === 'narrator';
                                })
                                .map((opt) => {
                                    return (
                                        <option key={`email_${opt}`} value={opt}>
                        ...
                        {/* <hr style={{margin: '5px 0px'}}/> */}
                        <p className="para-bold" style={{ marginBottom: '18px' }}>
